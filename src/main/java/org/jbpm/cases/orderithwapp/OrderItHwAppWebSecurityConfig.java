...
public class OrderItHwAppWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication().withUser("pamAdmin").password("{noop}redhatpam1!").roles("kie-server");
        ...
        auth.inMemoryAuthentication().withUser("tihomir").password("{noop}tihomir1!").roles("employees","manager");
