            ...
            //console.log($scope.managers);
             $scope.submitOrder = function() {
                ...
                OrderService.initOrder(appConfig.get('kieserver_url'), $scope.ownerInput,
                         $scope.selecValues.selectedcore,$scope.selecValues.selectedRam,
                         $scope.selecValues.selectedStorage,$scope.selecValues.selectedOS,$scope.selecValues.estimatedCost,
                        function (response) {
