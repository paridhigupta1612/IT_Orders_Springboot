...
.factory('ManagerService',
    ...
    function ($http, $rootScope) {
        ...
        service.GetTasks = function (serverUrl, page, pageSize, callback) {
            ...
            $http({method: 'GET', url: serverUrl + "/queries/tasks/instances/pot-owners?page=" + page + "&pageSize=" + pageSize + "&filter=MgrApproval" }).
      ...
      service.ClaimAndGetTask = function (serverUrl, caseId, callback) {
        var data = {
            "actors" : "manager",
